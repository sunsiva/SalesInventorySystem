...
Public Class rptRegistration
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sales_and_Inventory_System.rptRegistration.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRegistration
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRegistration = New rptRegistration()
        rpt.Site = Me.Site
        Return rpt
    End Function
